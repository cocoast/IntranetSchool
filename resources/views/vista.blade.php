<!doctype html>
 <html>
   ...
   <h1>Tipo de establecimiento</h1>
   <h1>"Nombre del Colegio"</h1>
	<h4>Telefono del colegio</h4>
	<h4>Direccion del colegio</h4>
	<h2>Certificado Anual de Inasistencia</h2> 
	<div>
<p>Con fecha <strong>{!!$date!!}</strong>, el Establecimiento de Educacion "Tipo del colegio""Nombre del Colegio", Confiere el presente CERTIFICADO DE INASISTENCIA a el estudiante:<strong>{!!$alumno->nombre!!} {!!$alumno->apellido!!} </strong>, del curso <strong>{!!$alumno->curso->nombre!!} </strong>, para ser usado en lo que estime comveniente.</p>
</div>
