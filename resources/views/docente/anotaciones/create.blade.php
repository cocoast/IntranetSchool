...
@section('tittle', 'Crear Anotaciones Alumno'. ' '. $alumno->nombre .' '.$alumno->apellido)
@section('content')
@if(count($errors)>0)
...
{!!Form::open(['route'=>'docente.anotaciones.store','method'=>'POST' ])!!}
...
{!!Form::date('fecha',\Carbon\Carbon::now(),['class'=>'form-control','step'=>'1','min'=>'2015-03-01'])!!}
</div>
<div class="form-group">
