...
<h4>Telefono: {!!$establecimiento->telefono!!}</h4>
	...
	<div class="parrafo-titulo">
		<h2><u>Informe de Notas Primer Semestre</u></h2> 
...
<div class="container">
<div><h4>Anotaciones Negativas o Atrasos: <strong>{{$negativas}}</strong></h4></div><div><h4>Anotaciones Positivas o Felicitaciones: <strong>{{$positivas}}</strong></h4></div>
