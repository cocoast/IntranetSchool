...
@section('content')
<div class="row">
	<h3><u>Comunicados</u></h3>
	<div class="row">
		<div class="col-md-1"><h4><u>fecha</u></h4></div>
		<div class="col-md-4"><h4><u>Contenido</u></h4></div>
	</div>
	@foreach($reunion as $comunicado)
	<div class="row">
	<div class="col-md-1">
		<h5>{{$comunicado->fecha}}</h5>

	</div>
	<div class="col-md-4">
		<h5>{{$comunicado->contenido}}</h5>
	</div>	
	</div>
	@endforeach
...
<h2>Notas</h2>
	<div class="col-md-4">
		<h4><u>Primer Semestre Alumno </u></h4>	
		<div id="columnchart1" class="chart"></div>
		</div>	
		@if($promedios['final2']!=0)
	<div class="col-md-4">
		<h4><u>Segundo Semestre Alumno</u></h4>
		<div id="columnchart2" class="chart"></div>
		</div>	
		@endif
	<div class="col-md-4">
		<h4><u>Alumno Versus Curso</u></h4>
...
<h2>Información destacada</h2>
	<div class="col-md-4">
	<h4><u>Asistencia Acumulada</u></h4>
